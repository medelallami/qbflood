...
export const floodSettingKeySchema = z.enum(
  Object.keys({
    ...
    UITorrentUseLastDestination: true,
...
export const floodSettingsSchema = z
  .object({
    ...
    UITorrentUseLastDestination: z.boolean().default(true),
    ...
    UISidebarFilterCategory: z.boolean().default(true),
  })
  .strict();
